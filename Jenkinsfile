            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        git fetch origin
                        git push https://${GIT_CREDENTIALS_USR}:${GIT_CREDENTIALS_PSW}@github.com/${GIT_CREDENTIALS_USR}/automated-release-demo.git --delete ${env.PRE_RELEASE_BRANCH} 2>/dev/null || true
